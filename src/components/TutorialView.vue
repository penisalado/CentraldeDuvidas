...
// (Mantendo todas as outras funções e lógica existente)
          ...
          <div class="upload-toolbar">
            <div class="upload-button">
              <input
                ...
                id="image-upload"
              />
              <label for="image-upload" class="toolbar-button">
                <Icon icon="material-symbols:add-photo-alternate" class="button-icon" />
                Imagem
              </label>
            </div>
            ...
            <div class="upload-button">
              <input
                ...
                id="video-upload"
              />
              <label for="video-upload" class="toolbar-button">
                <Icon icon="material-symbols:video-library" class="button-icon" />
                Vídeo
              </label>
            </div>
